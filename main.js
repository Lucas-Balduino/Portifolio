...
async function translatePage(targetLanguage) {
  const translations = {
    'en': {
      ...
      'hero.subtitle': 'Designer and UX/UI developer in training — I design and build intuitive interfaces, focused on performance and accessibility.',
      'hero.viewProjects': 'View projects',
      'hero.hireMe': 'Hire me',
      'hero.skills.web': 'HTML • CSS • JS',
      'hero.skills.tools': 'Figma • Git',
      'hero.skills.a11y': 'Accessibility • Responsive',
      'projects.title': 'Projects',
      'projects.subtitle': 'Code, deploys and architecture notes.',
      'projects.recent': 'Recent projects',
      'projects.viewAll': 'View all →',
      'projects.viewProject': 'View project',
      'projects.card.github': 'GitHub',
      'projects.card.liveDemo': 'Live Demo',
      ...
      'about.subtitle': 'Designer and UX/UI developer in training, passionate about creating intuitive and accessible interfaces.',
      'about.who.title': 'Who I am',
      'about.who.description': 'Hello! I\'m <strong>Lucas Gonçalves Balduino</strong>, a Design (UnB) and Computer Science (UniCEUB) student. I work at the intersection of UX/UI and front-end: I prototype interfaces, care about usability and turn visual ideas into working code.',
      ...
      'about.experience.cal': 'Extension project — CAL/UnB digital twins',
      'about.experience.cal.role': 'Volunteer (last semester) → Scholarship holder (current)',
      'about.experience.cal.description': 'Participation in the project to generate digital twins of artworks from the Casa de Cultura da América Latina (CAL/UnB) for an online archive. Involved in scanning the works and preparing the website that will become an appendix to the current CAL portal.',
      ...
      'about.experience.projects.description': 'Building front-end apps and interfaces focused on UX, UI and accessibility.',
    ...
    'es': {
      ...
      'hero.subtitle': 'Diseñador y desarrollador UX/UI en formación — diseño y construyo interfaces intuitivas, pensadas para rendimiento y accesibilidad.',
      'hero.viewProjects': 'Ver proyectos',
      'hero.hireMe': 'Contrátame',
      'hero.skills.web': 'HTML • CSS • JS',
      'hero.skills.tools': 'Figma • Git',
      'hero.skills.a11y': 'Accesibilidad • Responsivo',
      ...
      'projects.card.github': 'GitHub',
      'projects.card.liveDemo': 'Demo en vivo',
      ...
      'about.subtitle': 'Diseñador y desarrollador UX/UI en formación, apasionado por crear interfaces intuitivas y accesibles.',
      'about.who.title': 'Quién soy',
      'about.who.description': '¡Hola! Soy <strong>Lucas Gonçalves Balduino</strong>, estudiante de Diseño (UnB) y Ciencias de la Computación (UniCEUB). Trabajo en la intersección entre UX/UI y front-end: prototipo interfaces, cuido la usabilidad y transformo ideas visuales en código funcional.',
      ...
      'about.experience.cal': 'Proyecto de extensión — Gemelos digitales CAL/UnB',
      'about.experience.cal.role': 'Voluntario (último semestre) → Becario (actual)',
      'about.experience.cal.description': 'Participación en el proyecto de generación de gemelos digitales de obras de la Casa de Cultura de América Latina (CAL/UnB) para un acervo online. Actuación en el escaneo de las obras y en la preparación del sitio que será apéndice del portal actual de la CAL.',
      ...
      'about.experience.projects.description': 'Creación de aplicaciones front-end e interfaces con enfoque en UX, UI y accesibilidad.',
