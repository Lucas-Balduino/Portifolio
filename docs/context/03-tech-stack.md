...
| Preview / rodar | `npx serve .` | Admin e `fetch` do JSON falham em `file://` |
...
| Decisão | Escolha | Por quê |
|---|---|---|
| Framework | **Astro + ilhas React** (A1) | React já usado no Kinetic; islands sem SPA inteira; OG por rota |
